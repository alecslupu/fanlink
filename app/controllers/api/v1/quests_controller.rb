...
private
    ...
    def quest_params
        params.require(:quest).permit(:event_id, :name, :internal_name, :description, :status, :starts_at, :ends_at, quest_activities: %i[ description hint post image audio requires ])
    end    
end