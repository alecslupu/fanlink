json.cache! ["v3", message] do
  ...
  json.person do
    json.partial! "api/v4/people/person", locals: { person: message.person, relationships: Relationship.for_people(current_user, message.person) }
  end
  if message.mentions.count > 0
    json.mentions message.mentions, partial: "api/v4/messages/mention", as: :mention
  else
    json.mentions nil
  end
end
