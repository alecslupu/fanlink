json.cache! ["v3", post] do
  ...
  json.person do
    json.partial! "api/v4/people/person", locals: { person: post.person, relationships: Relationship.for_people(current_user, post.person) }
  end
  ...
  if post.tags.count > 0
    json.tags post.tags, partial: "api/v4/tags/tag", as: :tag
  else
    json.tag nil
  end
end
if defined?(post_reaction) && post_reaction.present?
  json.post_reaction post_reaction, partial: "api/v4/post_reactions/post_reaction", as: :post_reaction
else
