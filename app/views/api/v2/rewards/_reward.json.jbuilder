...
json.(reward, :internal_name, :reward_type, :reward_type_id, :series, :completion_requirement, :points,
      :status, :deleted)
...
reward.assigned_rewards.each do |assigned|
  if assigned.assigned_type == 'ActionType'
    ...
    json.action_types do
      json.child! do
        json.partial! 'api/v2/action_types/action_type', locals: { action: assigned.assigned, lang: nil }
    ...
    json.steps do
      json.child! do
        json.partial! 'api/v2/steps/step', locals: { step: assigned.assigned, lang: nil }
        json.set! :max_times, assigned.max_times
      end
    end
    ...
    json.quest_activities do
      json.child! do
        json.partial! 'api/v2/quest_activities/activity', locals: { activity: assigned.assigned, lang: nil }
        json.set! :max_times, assigned.max_times
      end
    end
    ...
    json.badges do
      json.child! do
        json.partial! 'api/v2/badges/badge', locals: { badge: assigned.assigned, lang: nil }
        json.set! :max_times, assigned.max_times
      end
    end
  else
