module Product::Views
  ...
  included do
    ...
    api_accessible :product_v3, extend: :product_v2 do |template|
    end

    api_accessible :product_v4, extend: :product_v3 do |template|
    end


    api_accessible :product_v5, extend: :product_v4 do |template|
    end
