class Person < ApplicationRecord
  ...
  validates :email, presence: { message: "is required." }, if: Proc.new { |p| p.facebookid.blank? }
  validates :email, email: { message: "is invalid.", allow_nil: true }
