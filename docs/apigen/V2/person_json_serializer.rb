class PersonJsonSerializer < ActiveModel::Serializer
nil#<Openapi2ruby::Openapi::Schema:0x00007ffff246eea8 @name="PersonJson", @definition={"type"=>"object", "properties"=>{"id"=>{"type"=>"integer"}, "username"=>{"type"=>"string"}, "name"=>{"type"=>"string"}, "gender"=>{"type"=>"string"}, "city"=>{"type"=>"string"}, "biography"=>{"type"=>"string"}, "country_code"=>{"type"=>"string"}, "birthdate"=>{"type"=>"string"}, "picture_url"=>{"type"=>"string"}, "product_account"=>{"type"=>"boolean"}, "recommended"=>{"type"=>"boolean"}, "chat_banned"=>{"type"=>"boolean"}, "designation"=>{"type"=>"string"}, "following_id"=>{"type"=>"integer"}, "relationships"=>{"type"=>"array", "items"=>{"type"=>"object", "properties"=>{"relationship"=>{"$ref"=>"#/components/schemas/Relationship"}}}}, "badge_points"=>{"type"=>"integer"}, "role"=>{"type"=>"string"}, "level"=>{"type"=>"string"}, "do_not_message_me"=>{"type"=>"boolean"}, "pin_messages_from"=>{"type"=>"boolean"}, "auto_follow"=>{"type"=>"boolean"}, "num_followers"=>{"type"=>"integer"}, "num_following"=>{"type"=>"integer"}, "facebookid"=>{"type"=>"integer"}, "facebook_picture_url"=>{"type"=>"string"}, "created_at"=>{"type"=>"string", "format"=>"date-time"}, "updated_at"=>{"type"=>"string", "format"=>"date-time"}}, "description"=>"Person Response"}>  attributes :id, :username, :name, :gender, :city, :biography, :country_code, :birthdate, :picture_url, :product_account, :recommended, :chat_banned, :designation, :following_id, :relationships, :badge_points, :role, :level, :do_not_message_me, :pin_messages_from, :auto_follow, :num_followers, :num_following, :facebookid, :facebook_picture_url, :created_at, :updated_at
