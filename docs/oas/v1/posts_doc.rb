class Api::V1::PostsDoc < Api::V1::BaseDoc
  ...
  api :index, "Get posts for a date range." do
    ...
    query :from_date, String, format: "date", desc: 'From date in format "YYYY-MM-DD". Note valid dates start from 2017-01-01.'
    query :to_date, String, format: "date", desc: 'To date in format "YYYY-MM-DD". Note valid dates start from 2017-01-01.'
