class Api::V3::QuestsDoc < Api::V3::BaseDoc
  ...
  api :completion, "Get a quest completions for current user" do
    need_auth :SessionCookie
    path! :quest_id, Integer, desc: "The quest id for the completions you are wanting to retrieve."
    desc "Returns all quest completions associated with the quest id for the currently logged in user."
