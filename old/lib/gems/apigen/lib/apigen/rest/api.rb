...
module Apigen
  ...
  module Rest
    ...
    class Api
      ...
      attr_reader :tags
      attribute_setter_getter :version
      attribute_setter_getter :title
      attribute_setter_getter :description
      attribute_setter_getter :tos
      attribute_setter_getter :contact
      attribute_setter_getter :license
      attribute_setter_getter :servers
