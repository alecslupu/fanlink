define({ "api": [
  ...
  },
  {
    ...
    "group": "People",
    "version": "1.0.0",
    "description": "<p>This is used to create a new person.</p> <p>If the account creation is successful, they will be logged in and we will send an onboarding email (if we have an email address for them).</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "recommended",
            "description": "<p>Whether this is a recommended persion. (Admin or product account only)</p>"
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "group": "Posts",
    "version": "1.0.0",
    "description": "<p>This creates a post and puts in on the feed of the author's followers. It also sends a push notification to poster's followers if the notify_followers flag is set to true.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
          ...
          },
          {
            ...
            "description": "<p>(Admin or product account) Whether the post is recommended.</p>"
          },
          {
            "group": "Parameter",
            "type": "Boolean",
            "optional": true,
            "field": "post.notify_followers",
            "description": "<p>Whether a push notification should be sent to the posters followers.</p>"
          }
        ]
      }
    },
        ...
        "200": [
          {
            ...
            "optional": false,
            "field": "quest_activity",
            "description": "<p>Returns the create quest activity</p> <p>curl -X POST <br> http://localhost:3000/quests/1/activities <br> -H 'Accept: application/vnd.api.v2+json' <br> -H 'Accept-Language: en' <br> -H 'Cache-Control: no-cache' <br> -H 'Content-Type: multipart/form-data' <br> -H 'content-type: multipart/form-data; boundary=----WebKitFormBoundary7MA4YWxkTrZu0gW' <br> -F 'quest_activity[description]=Escape to Boston' <br> -F 'quest_activity[hint]=Find the glasses' <br> -F 'quest_activity[beacon]=123456-7890' <br> -F 'quest_activity[activity_code]=293812' <br> -F 'quest_activity[step]=0' <br> -F 'quest_activity[picture]=undefined'</p>"
          }
        ]
      },
      "examples": [
  ...
  {
    "type": "get",
    "url": "/quest_activity/:id/completions",
    "title": "Get completions for a person",
  ...
  },
  {
    ...
    "title": "Get completions for quest",
    "name": "GetCompletions",
    "group": "Quests",
    "version": "1.0.0",
    "parameter": {
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "room.picture",
            "description": "<p>Picture for the room.</p>"
          },
          {
            "group": "Parameter",
            "type": "Array",
