...
RSpec.describe MerchandisePolicy, type: :policy do
  ...
  context "logged in admin with read permission" do
    ...
    subject { described_class.new(create(:portal_access, merchandise_read: true).person, master_class) }
  ...
  context "logged in admin with update permission" do
    ...
    subject { described_class.new(create(:portal_access, merchandise_update: true).person, master_class) }
  ...
  context "logged in admin with delete permission" do
    ...
    subject { described_class.new(create(:portal_access, merchandise_delete: true).person, master_class) }
  ...
  context "logged in admin with export permission" do
    ...
    subject { described_class.new(create(:portal_access, merchandise_export: true).person, master_class) }
  ...
  context "logged in admin with history permission" do
    ...
    subject { described_class.new(create(:portal_access, merchandise_history: true).person, master_class) }
