...
RSpec.describe EventPolicy, type: :policy do
  let(:master_class) { EventCheckin.new }
  ...
  context "logged in user with no permission" do
    ...
    describe "protected methods" do
      it { expect(subject.send(:module_name)).to eq("event") }
  ...
  context "logged in admin with read permission" do
    ...
    subject { described_class.new(create(:portal_access, event_read: true).person, master_class) }
  ...
  context "logged in admin with update permission" do
    ...
    subject { described_class.new(create(:portal_access, event_update: true).person, master_class) }
  ...
  context "logged in admin with delete permission" do
    ...
    subject { described_class.new(create(:portal_access, event_delete: true).person, master_class) }
  ...
  context "logged in admin with export permission" do
    ...
    subject { described_class.new(create(:portal_access, event_export: true).person, master_class) }
  ...
  context "logged in admin with history permission" do
    ...
    subject { described_class.new(create(:portal_access, event_history: true).person, master_class) }
