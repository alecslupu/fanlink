...
RSpec.describe PersonInterestPolicy, type: :policy do
  let(:master_class) { PersonInterest.new }
  ...
  context "logged in user with no permission" do
    ...
    describe "protected methods" do
      it { expect(subject.send(:module_name)).to eq("interest") }
  ...
  context "logged in admin with read permission" do
    ...
    subject { described_class.new(create(:portal_access, interest_read: true).person, master_class) }
  ...
  context "logged in admin with update permission" do
    ...
    subject { described_class.new(create(:portal_access, interest_update: true).person, master_class) }
  ...
  context "logged in admin with delete permission" do
    ...
    subject { described_class.new(create(:portal_access, interest_delete: true).person, master_class) }
  ...
  context "logged in admin with export permission" do
    ...
    subject { described_class.new(create(:portal_access, interest_export: true).person, master_class) }
  ...
  context "logged in admin with history permission" do
    ...
    subject { described_class.new(create(:portal_access, interest_history: true).person, master_class) }
