...
RSpec.describe DownloadFilePagePolicy, type: :policy do
  permission_list = {
    index: false,
    show: false,
    create: false,
  ...
  describe "defined policies" do
    subject { described_class.new(Person.new, DownloadFilePage.new) }
  ...
  context "logged out user" do
    subject { described_class.new(nil, DownloadFilePage.new) }
  ...
  context "user with super admin role and with admin product" do
    ...
    subject { described_class.new(Person.new(role: :super_admin, product: product), DownloadFilePage.new) }
