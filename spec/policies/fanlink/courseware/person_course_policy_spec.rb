...
RSpec.describe Fanlink::Courseware::PersonCoursePolicy, type: :policy do
  args = Fanlink::Courseware::PersonCourse, 'courseware'
  ...
  let(:master_class) { Fanlink::Courseware::PersonCourse.new }
