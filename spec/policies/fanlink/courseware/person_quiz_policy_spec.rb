...
RSpec.describe Fanlink::Courseware::PersonQuizPageAnswerPolicy, type: :policy do
  args = Fanlink::Courseware::PersonQuizPageAnswer, 'courseware'
  ...
  context 'Scope' do
    it 'should only return the person quiz in current product' do
      ...
      ActsAsTenant.with_tenant(person.product) do
        ...
        scope = Pundit.policy_scope!(person, Fanlink::Courseware::PersonQuizPageAnswer)
