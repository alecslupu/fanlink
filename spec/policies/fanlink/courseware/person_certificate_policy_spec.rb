...
RSpec.describe Fanlink::Courseware::PersonCertificatePolicy, type: :policy do
  args = Fanlink::Courseware::PersonCertificate, 'courseware'
  ...
  context 'Scope' do
    it 'should only return the certificate in current product' do
      ...
      ActsAsTenant.with_tenant(person.product) do
        ...
        scope = Pundit.policy_scope!(person, Fanlink::Courseware::PersonCertificate)
