...
RSpec.describe Api::V1::PostsController, type: :controller do
  ...
  describe '#create' do
    ...
    it 'should create a new post and publish it with a lot of fields normal users really should not have access to' do
      person = create(:person)
      ActsAsTenant.with_tenant(person.product) do
        login_as(person)
        body = 'Do you like my body?'
        ...
        post :create, params: { post: {
          body: body, global: true, starts_at: startat, ends_at: endat,
          repost_interval: rpi, status: 'rejected', priority: prior
        } }
        expect(response).to be_successful
        post = Post.last
  ...
  describe '#index' do
    ...
    it 'should get a list of posts for a date range without limit' do
      ...
      ActsAsTenant.with_tenant(person.product) do
        ...
        expect(response).to be_successful
        post_list = [postloggedin.id.to_s, post22.id.to_s, post21.id.to_s, post12.id.to_s, post11.id.to_s]
        expect(json['posts'].map { |p| p['id'] }).to eq(post_list)
      end
    end
  ...
  describe '#update' do
    ...
    it 'should not let normal user update recommended' do
      ...
      ActsAsTenant.with_tenant(person.product) do
        ...
        patch :update, params: { id: flinkpost.id, post: {
          body: newbody, global: global, starts_at: starts_at, ends_at: ends_at,
