...
describe UserReferredListener do
  describe "#person_created" do
    it "dies silently if no user passed" do
      ...
      expect(UserReferredListener.person_created(nil, {referer: code.unique_code })).to be_falsey
    end
    ...
    it "it works " do
      ...
      expect(UserReferredListener.person_created(create(:person).id, {referer: code.unique_code })).to be_truthy
