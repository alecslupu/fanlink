module JsonHelpers
  module V2
    ...
    def following_v2_json(following, currnt_user)
      {
        "id"       => following.id.to_s,
        "follower" => person_v2_json(following.follower, currnt_user),
        "followed" => person_v2_json(following.followed, currnt_user)
      }
    end
    def level_v2_json(level, lang = nil)
      {
          "id"                  => level.id.to_s,
          "name"                => level.name,
    ...
    def merchandise_v2_json(merchandise)
      {
    ...
    def message_v2_json(msg)
      {
        ...
        "person" => person_v2_json(msg.person),
        "mentions" => message_mentions_v2_json(msg)
      }
    end
    def message_list_v2_json(msg)
      {
          "id"        => msg.id.to_s,
    ...
    def message_mentions_v2_json(msg)
    ...
    def message_reports_v2_json(msg_report)
      {
    ...
    def pending_badge_v2_json(earned, badge)
      {
        "badge_action_count"  => earned,
        "badge"               => badge_v2_json(badge)
      }
    end
    def person_private_v2_json(person, potential_follower = nil)
      person_v2_json(person, potential_follower).merge(
        "email" => person.email
      )
    end
    def person_v2_json(person, potential_follower = nil, lang = nil)
      following = (potential_follower) ? potential_follower.following_for_person(person) : nil
      {
        ...
        "role"              => person.role,
        "level"             => (person.level.nil?) ? nil : level_v2_json(person.level),
    ...
    def person_share_v2_json(person, potential_follower = nil, lang = nil)
      following = (potential_follower) ? potential_follower.following_for_person(person) : nil
      {
        "username"          => person.username,
        "picture_url"       => person.picture_url
    ...
    def post_comment_v2_json(post_comment)
      {
        "id"            => post_comment.id.to_s,
        "create_time"   => post_comment.created_at.to_s,
        "body"          => post_comment.body,
        "mentions"      => post_comment_mentions_v2_json(post_comment),
        "person"        => person_v2_json(post_comment.person)
      }
    end
    def post_comment_list_v2_json(post_comment, lang = nil)
      {
          "id"              => post_comment.id.to_s,
    ...
    def post_comment_mentions_v2_json(post_comment)
    ...
    def post_comment_report_v2_json(post_comment_report)
      {
    ...
    def post_v2_json(post, lang = nil, reaction = nil)
      {
        "id"          => post.id.to_s,
        ...
        "person" => person_v2_json(post.person),
        "post_reaction_counts" => post.reaction_breakdown.to_v2_json,
        "post_reaction"     => (reaction.nil?) ? nil : post_reaction_v2_json(reaction),
        "global"            => post.global,
    ...
    def post_share_v2_json(post, lang = nil, reaction = nil)
      {
        "body"        => (lang.present?) ? post.body(lang) : post.body,
        "picture_url" => post.picture_url,
        "person" => person_share_v2_json(post.person),
      }
    end
    def post_list_v2_json(post, lang = nil)
      {
        "id"              => post.id.to_s,
        "person"          => person_v2_json(post.person),
        "body"            => (lang.present?) ? post.body(lang) : post.body,
    ...
    def post_reaction_v2_json(post_reaction)
      {
    ...
    def post_report_v2_json(post_report)
      {
    ...
    def post_share_v2_json(post, lang = nil)
      {
        "body"        => (lang.present?) ? post.body(lang) : post.body,
        "picture_url" => post.picture_url,
    ...
    def relationship_v2_json(relationship, currnt_user)
      {
        "id"            => relationship.id.to_s,
        "status"        => relationship.status,
        "create_time"   => relationship.created_at.to_s,
        "update_time"   => relationship.updated_at.to_s,
        "requested_by"  => person_v2_json(relationship.requested_by, currnt_user),
        "requested_to"  => person_v2_json(relationship.requested_to, currnt_user)
      }
    end
  end
end
