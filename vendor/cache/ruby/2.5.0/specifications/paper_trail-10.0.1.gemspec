# -*- encoding: utf-8 -*-
# stub: paper_trail 10.0.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<paper_trail-association_tracking>.freeze, ["< 2"])
      ...
      s.add_dependency(%q<paper_trail-association_tracking>.freeze, ["< 2"])
