# -*- encoding: utf-8 -*-
# stub: mandrill_mailer 1.7.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.email = ["adamrensel@gmail.com".freeze]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<mandrillus>.freeze, ["~> 2.0.0"])
      ...
      s.add_dependency(%q<mandrillus>.freeze, ["~> 2.0.0"])
