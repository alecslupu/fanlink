# -*- encoding: utf-8 -*-
# stub: cucumber 4.0.0.rc.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.summary = "cucumber-4.0.0.rc.1".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<cucumber-core>.freeze, ["~> 4.0"])
      s.add_runtime_dependency(%q<cucumber-expressions>.freeze, [">= 6.0.1", "~> 6.0"])
      s.add_runtime_dependency(%q<cucumber-formatter-dots>.freeze, ["~> 1.0"])
      s.add_runtime_dependency(%q<cucumber-wire>.freeze, ["~> 1.0"])
      s.add_runtime_dependency(%q<diff-lcs>.freeze, ["~> 1.3"])
      s.add_runtime_dependency(%q<gherkin>.freeze, ["~> 6.0"])
      ...
      s.add_dependency(%q<cucumber-core>.freeze, ["~> 4.0"])
      s.add_dependency(%q<cucumber-expressions>.freeze, [">= 6.0.1", "~> 6.0"])
      s.add_dependency(%q<cucumber-formatter-dots>.freeze, ["~> 1.0"])
      s.add_dependency(%q<cucumber-wire>.freeze, ["~> 1.0"])
      s.add_dependency(%q<diff-lcs>.freeze, ["~> 1.3"])
      s.add_dependency(%q<gherkin>.freeze, ["~> 6.0"])
