# -*- encoding: utf-8 -*-
# stub: cucumber-expressions 6.6.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/cucumber/cucumber/issues", "changelog_uri" => "https://github.com/cucumber/cucumber/blob/master/cucumber-expressions/CHANGELOG.md", "documentation_uri" => "https://docs.cucumber.io/cucumber/cucumber-expressions/", "mailing_list_uri" => "https://groups.google.com/forum/#!forum/cukes", "source_code_uri" => "https://github.com/cucumber/cucumber/blob/master/cucumber-expressions/ruby" } if s.respond_to? :metadata=
  ...
  s.summary = "cucumber-expressions-6.6.2".freeze
